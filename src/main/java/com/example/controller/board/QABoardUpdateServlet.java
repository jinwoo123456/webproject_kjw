...
@WebServlet("/views/qa_board_update.do")
   ...
   protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
      ...
      HttpSession session = req.getSession();
		...
		if (userId == null || !userId.equals(authorId)) {
			...
			JSFunction.alertLocation(resp, "작성자 본인만 수정이 가능합니다.", "../views/qa_board.do");
			return;
		}
        ...
        if (result > 0) {
			JSFunction.alertLocation(resp, "글이 성공적으로 수정되었습니다.", "../views/qa_board.do");
