...
<body>
    <div class="container">
        ...
        <div class="button-group">
            ...
            <a href="free_board_view_update.jsp?post_id=${freeBoardView.post_id}&id=${freeBoardView.id}&content=${freeBoardView.content}&title=${freeBoardView.title}" class="button-link">수정하기</a>
            </c:if>
...
<div class="comment-section">
    ...
    <form action="comment_write.do" method="post">
        <input type="hidden" name="post_id" value="${freeBoardView.post_id}">
